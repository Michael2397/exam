...
<div class="leftnav">
  ...
  <ul>
   	 <li><a href="column.html" target="right"><span class="icon-caret-right"></span>本次考试结果分析</a></li>    
	 <li><a href="column.html" target="right"><span class="icon-caret-right"></span>综合分析</a></li> 
  </ul>  -->
</div>
